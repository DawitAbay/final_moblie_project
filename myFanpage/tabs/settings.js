        ...
        <ScrollView >
          ...
          <View style={{ height: devHeight + devHeight * 1 / 100 }}>
            ...
            <TouchableOpacity onPress={this.pickImage} style={styles.container} >
              <MaterialIcons name="add-a-photo" size={24} color={'red'} style={{ marginTop: 20, marginLeft: 15 }} />
              <Text style={{ textAlign: 'center', color: "white", fontSize: 20, fontFamily: 'AppleSDGothicNeo-Bold', marginTop: 22, marginRight: 60 }}>Add/Change Profile Photo</Text>
            </TouchableOpacity>


            <TouchableOpacity style={styles.container1} onPress={this.edit}>
              <AntDesign name="edit" size={24} color={'red'} style={{ marginTop: 20, marginLeft: 15 }} />
              <Text style={{ textAlign: 'center', color: "white", fontSize: 20, fontFamily: 'AppleSDGothicNeo-Bold', marginTop: 22, marginRight: 200 }}>Edit Name</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.container1} onPress={this.edit2} >
              <AntDesign name="edit" size={24} color={'red'} style={{ marginTop: 20, marginLeft: 15 }} />
              <Text style={{ textAlign: 'center', color: "white", fontSize: 20, fontFamily: 'AppleSDGothicNeo-Bold', marginTop: 22, marginRight: 200 }}>Edit Email</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.container1} onPress={this.edit3} >
              <AntDesign name="edit" size={24} color={'red'} style={{ marginTop: 20, marginLeft: 15 }} />
              <Text style={{ textAlign: 'center', color: "white", fontSize: 20, fontFamily: 'AppleSDGothicNeo-Bold', marginTop: 22, marginRight: 170 }}>Edit Password</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.container1} onPress={() => { this.props.navigation.navigate('About') }} >
              <AntDesign name="infocirlce" size={24} color={'red'} style={{ marginTop: 20, marginLeft: 15 }} />
              <Text style={{ textAlign: 'center', color: "white", fontSize: 20, fontFamily: 'AppleSDGothicNeo-Bold', marginTop: 22, marginRight: 240 }}>About</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.container1} onPress={this.signoutUser}>
              <AntDesign name="logout" size={24} color={'red'} style={{ marginTop: 20, marginLeft: 15 }} />
              <Text style={{ textAlign: 'center', color: "white", fontSize: 20, fontFamily: 'AppleSDGothicNeo-Bold', marginTop: 22, marginRight: 230 }}>Logout</Text>
            </TouchableOpacity>
