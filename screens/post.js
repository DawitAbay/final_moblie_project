...
import { View, Text, TouchableOpacity, TextInput, StyleSheet, Platform, Image, Modal, TouchableWithoutFeedback, SafeAreaView, ScrollView, Keyboard } from 'react-native'
    ...
    return (
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <SafeAreaView>
          ...
          <View style={styles.Admobcontainerpost}>
            <AdMobBanner
